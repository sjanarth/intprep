...
public class StepsAndStairs extends com.coreds.recursion.problems.StepsAndStairs
{
	...
	protected static void countStepsAndStairs(int n, int[] steps)	{
		com.coreds.recursion.problems.StepsAndStairs.countStepsAndStairs(n, steps);
